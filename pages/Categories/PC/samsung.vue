...
const brandName = "samsung" || "Samsung";

const { data: response } = await useFetch(`${config.public.apiBase}/pcs?brand=${brandName}&fields[]=name&fields[]=price&fields[]=brand&per_page=4`);
...
<template>
    <UserLayout>
        ...
        <Head>
            <Title>Samsung Computers - {{ $config.public.appName }}</Title>
        </Head>

        <main class="dark:text-gray-400">
            <div class="container mx-auto px-4">
                <SearchBar class="mt-5 mb-6" :placeholder="'Search Samsung Computers...'" />
