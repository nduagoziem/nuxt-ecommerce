...
const { data } = await useFetch(`${config.public.apiBase}/tablets?brand=${brandName}&fields[]=name&fields[]=price&fields[]=brand`);
...
<template>
    <UserLayout>
        ...
        <Head>
            <Title>Samsung Tablets - {{ $config.public.appName }}</Title>
        </Head>

        <main class="dark:text-gray-400">
            <div class="container mx-auto px-4">
                <SearchBar class="mt-5 mb-6" :placeholder="'Search Samsung Tablets...'" @search="searchRequest" />
